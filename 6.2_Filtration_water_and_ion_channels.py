...
### Water and ion channel filtration ###
...
Channel_filtration_list = "Filtration_list_water_and_ion_channels.csv"

# Files input #
Sample1_file_FACS = "Sample1_FACS_channels_unfiltered.csv"
Sample2_file_PT = "Sample2_PT_channels_unfiltered.csv"
Sample3_file_Male = "Sample3_Male_channels_unfiltered.csv"
Sample4_file_Female = "Sample4_Female_channels_unfiltered.csv"
...
with open(os.path.join(folder1,Channel_filtration_list),'r') as read:
    next(read)
    for line in read:
        line = line.strip().split(';')
